...
public class OnDragPinchTouchListener implements View.OnTouchListener {
    ...
    public OnDragPinchTouchListener(View view) {
        this(view, (View) view.getParent(), null);
    }

    public OnDragPinchTouchListener(View view, View parent) {
        this(view, parent, null);
    }

    OnDragPinchTouchListener(View view, OnDragActionListener onDragActionListener) {
        this(view, (View) view.getParent(), onDragActionListener);
    }

    OnDragPinchTouchListener(View view, View parent, OnDragActionListener onDragActionListener) {
